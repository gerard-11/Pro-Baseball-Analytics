                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-8 sm:mb-10 md:mb-12">
                        ...
                        <div className="max-w-2xl mx-auto">
                            <input
                                ...
                                className="w-full px-4 py-3 sm:px-6 sm:py-4 text-sm sm:text-base md:text-lg border-2 border-blue-400 rounded-lg focus:outline-none focus:border-blue-600 shadow-md transition"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                            ...
                            <div className="mb-6">
                                <div className="bg-blue-100 border-l-4 border-blue-500 p-4 rounded">
                                    <p className="text-xs sm:text-sm md:text-base text-blue-800 font-semibold">
                                        Found <span className="text-base sm:text-lg md:text-lg font-bold">{results.length}</span> player{results.length !== 1 ? "s" : ""}
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        {!hasSearched && (
                            <div className="flex flex-col items-center justify-center py-12 sm:py-16 bg-white rounded-xl shadow-lg px-4">
                                <div className="text-4xl sm:text-5xl md:text-6xl mb-4">⚾</div>
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Start your search</h2>
                                <p className="text-xs sm:text-sm text-gray-600 text-center max-w-md">
